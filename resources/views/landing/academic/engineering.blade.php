            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                     ...
                     <p class="post-title">{{__('partials/navbar.navbar.engineering')}}</p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-12">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">{{__('academy/engineering.engineering.purpose.title')}}</h1>
                        <h4 class="mb-30">{{__('academy/engineering.engineering.purpose.subtitle_vision')}}</h4>
                        <p class="mb-30">{{__('academy/engineering.engineering.purpose.description_vision')}}</p>

                        <h4 class="mb-30">{{__('academy/engineering.engineering.purpose.subtitle_mission')}}</h4>
                        <table class="text-secondary mb-30" style="border-collapse: collapse; width: 100%;">
                           @foreach (trans('academy/engineering.engineering.purpose.description_mission') as $key => $mission)
                              <tr>
                        ...
                        <h4 class="mb-30">{{__('academy/engineering.engineering.purpose.subtitle_purpose')}}</h4>
                        <table class="text-secondary mb-30" style="border-collapse: collapse; width: 100%;">
                           @foreach (trans('academy/engineering.engineering.purpose.description_purpose') as $key => $mission)
                              <tr>
                                 <td style="width: 3%; vertical-align: top;">{{ $key }}</td>
                                 <td>{{ $mission }}</td>
                              </tr>
                    ...
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">{{__('academy/engineering.engineering.curriculum.title')}}</h1>
                        <div class="col-12 col-lg-12">
                            <div class="accordions mb-50" id="accordion" role="tablist" aria-multiselectable="true">
                              @foreach (trans('academy/engineering.engineering.curriculum.content') as $semester => $courses)
                                             ...
                                             <table style="width: 100%; border-collapse: collapse;">
                                                <thead>
                                                   <tr>
                                                         ...
                                                         <th style="border: 1px solid #ddd; padding: 8px;">{{__('academy/engineering.engineering.curriculum.course')}}</th>
                                                         <th class="text-center" style="border: 1px solid #ddd; padding: 8px;">{{__('academy/engineering.engineering.curriculum.credit')}}</th>
                                                   </tr>
                                                </thead>
                                                <tbody>
